...
- [x] 4.1 Full `npm run test:e2e` passes locally (seed + main-flow) — c295cc9
- [x] 4.2 Lint passes — c295cc9

#### Manual

- [x] 4.3 Main-flow uses mock provider path (checkbox or network evidence) — c295cc9

### Phase 5: Playwright in CI

#### Automated

- [x] 5.1 CI workflow runs `npm run test:e2e` successfully — 2843965
...
- [x] 6.1 Full local gate: typecheck, lint, test, build, test:e2e — 5de8ca6
- [x] 6.2 test-plan §6.3 and §3 Phase 4 updated — 5de8ca6

#### Manual

- [x] 6.3 §6.3 recipe matches file names in repo — 6e01d77
